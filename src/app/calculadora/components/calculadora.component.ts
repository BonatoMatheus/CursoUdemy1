...
import { iCalculadoraService } from '../services';
...
export class CalculadoraComponent implements OnInit {
  ...
  constructor(@Inject('iCalculadoraService') private calculadoraService:iCalculadoraService)  { 
    var resultado = calculadoraService.calcular(1, 2, "/");
